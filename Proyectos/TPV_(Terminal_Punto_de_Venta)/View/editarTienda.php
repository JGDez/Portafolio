            ...
            <div class="flexRow ancho100xC">
                ...
                <div id="lista_form" class="ancho70xC">
                    <div class="divInput ancho40xC">
                        ...
                        <input type="text" name="cif_nif" id="cif_nif" value="<?= $tienda->getCifNif() ?>" placeholder="C.I.F. o N.I.F." required maxlength="9">
                    </div>
                    <div class="divInput">
                        <label for="nombre_Fis">Nombre Fiscal</label><br>
                        <input type="text" name="nombre_Fis" id="nombre_Fis" value="<?= $tienda->getNombreFis() ?>" placeholder="Nombre Fiscal de la empresa" required maxlength="50">
                    </div>
                    <div class="divInput">
                        <label for="nombre_Com">Nombre Comercial</label><br>
                        <input type="text" name="nombre_Com" id="nombre_Com" value="<?= $tienda->getNombreCom() ?>" placeholder="Nombre Comercial de la emrpesa" required maxlength="50">
                    </div>
                    <div class="flexRow">
                        <div class="ancho60xC divInput">
                            <label for="direccion">Dirección</label><br>
                            <input type="text" name="direccion" id="direccion" value="<?= $tienda->getDireccion() ?>" placeholder="Dirección postal" required maxlength="100">
                        </div>
                        <div class="ancho40xC divInput">
                            <label for="poblacion">Población</label><br>
                            <input type="text" name="poblacion" id="poblacion" value="<?= $tienda->getPoblacion() ?>" placeholder="Población" required maxlength="50">
                        </div>
                    </div>
                    <div class="flexRow">
                        <div class="ancho40xC divInput">
                            <label for="cp">Código Postal</label><br>
                            <input type="text" name="cp" id="cp" value="<?= $tienda->getCp() ?>" placeholder="Código postal" required maxlength="5">
                        </div>
                        <div class="ancho40xC divInput">
                            <label for="provincia">Provincia</label><br>
                            <input type="text" name="provincia" id="provincia" value="<?= $tienda->getProvincia() ?>" placeholder="Provincia" required maxlength="50">
                        </div>
                    </div>
                    <div class="divInput">
                        <label for="email">Correo electrónico</label><br>
                        <input type="email" name="email" id="email" value="<?= $tienda->getEmail() ?>" placeholder="Dirección de correo electrónico" maxlength="100">
                    </div>
                    <div class="flexRow">
                        <div class="ancho40xC divInput">
                            <label for="telef">Teléfono</label><br>
                            <input type="text" name="telef" id="telef" value="<?= $tienda->getTelef() ?>" placeholder="Número de teléfono" maxlength="15">
                        </div>
                        <div class="ancho40xC divInput">
                            <label for="movil">Móvil</label><br>
                            <input type="text" name="movil" id="movil" value="<?= $tienda->getMovil() ?>" placeholder="Número de móvil" maxlength="15">
                        </div>
                    </div>
